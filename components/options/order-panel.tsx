    ...
    <div className="glass rounded-2xl p-5 h-full flex flex-col">
      ...
      <div className="mb-4">
        ...
        <select
          ...
          className="w-full bg-surface-overlay border border-border rounded-xl pl-4 pr-10 py-2.5
            font-numbers text-sm text-text-primary
            focus:outline-none focus:border-accent/50 focus:ring-1 focus:ring-accent/40
